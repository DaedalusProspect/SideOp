...
ASideOpAIController::ASideOpAIController(const FObjectInitializer& ObjectInitializer) :
	Super(ObjectInitializer/*.SetDefaultSubobjectClass<USideOpPathFollowingComponent>(TEXT("PathFollowingComp"))*/)
{
